...
export const DATA = {
  ...
  contact: {
    email: "ahmedk.ryan@gmail.com",
    tel: "+201091455414",
    social: {
      GitHub: {
        name: "GitHub",
        url: "https://github.com/AhmedRayyan",
        icon: Icons.github,
      ...
      LinkedIn: {
        name: "LinkedIn",
        url: "https://www.linkedin.com/in/a7madrayyan/",
        icon: Icons.linkedin,
      ...
      Email: {
        name: "Send Email",
        url: "mailto:ahmedk.ryan@gmail.com",
        icon: Icons.email,
  ...
  work: [
    {
      company: "Digthisdeal - (Peakaboo Formerly)",
      href: "https://www.digthisdeal.com/",
      badges: [],
      location: "Remote",
